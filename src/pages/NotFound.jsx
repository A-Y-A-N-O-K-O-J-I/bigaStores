  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-black text-white text-center">
      <div className="space-y-6 max-w-md w-full p-8 bg-gray-900 rounded-xl shadow-2xl">
        {/* Image */}
        <img src="/repair.png" alt="Repair" className="mx-auto mb-4 w-40 h-40 object-cover" />
        ...
        <Link
          to="/"
          className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 transition duration-200"
        >
          Back to Home
        </Link>
      </div>
